...
def mergeCatalogs(mergeDf,mergeToDf,colRename,colDelete=None,resids=True,specZ='specZ',
                  photoZ_ML='photoZ_ML',photoZ_SED='photoZ_SED',how='inner'):
    residML='resid_ML'
    residSED='resid_SED'
    residML_SED='residML_SED'
    outDf=mergeDf.merge(mergeToDf.set_index('Seq'), on='Seq',how=how)
